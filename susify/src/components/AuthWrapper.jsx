        ...
        >
          <div className="flex flex-col justify-center items-center p-8 gap-7">
            <h3 className="text-2xl font-semibold to-slate-700">
              {type === "login" ? "Login to Susify" : "Signup to Susify"}
            </h3>
            ...
            <div className="flex flex-col gap-5">
              ...
              />
              <button
                className="bg-lilac text-white px-12 text-lg font-semibold rounded-r-md p-3 w-80"
                onClick={handleClick}
                type="button"
              >
                Continue
            ...
            <span className="text-sm text-slate-700">
              {type === "login" ? (
                <>
                  Not a member yet?{" "}
                  <span
                    className="text-lilac cursor-pointer"
                    onClick={() => {
                      dispatch({
